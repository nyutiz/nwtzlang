...
use crate::lib::{evaluate, mk_native_fn, mk_null, mk_number, native_registry, tokenize, ArrayVal, BooleanVal, Environment, NullVal, NumberVal, Parser, Program, RuntimeVal, StringVal, Token};
pub mod lib;
...
pub fn make_global_env() -> lib::Environment {
